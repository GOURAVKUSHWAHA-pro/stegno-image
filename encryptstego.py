...
def open_encode_window():
    ...
    if not encode_opened:
        ...
        encode_window.title("Steganography - Encode")
        ...
        raw_image_label = Label(encode_window, text="Select Raw Image", height=20, width=50, relief="solid", bg="#0000FF")
...
def open_decode_window():
    ...
    if not decode_opened:
        ...
        decode_window.title("Steganography - Decode")
...
def help_menu():
    ...
    if not help_opened:
        ...
        text_to_decode_label = Label(help_window, text="\n Steganography\nDeveloped by @GOURAVKUSHWAHA-pro\nLinkedIn-https://www.linkedin.com/in/gourav-kushwaha-edu-research/\nGithub-https://github.com/GOURAVKUSHWAHA-pro\n")
        text_to_decode_label.config(font=("Open Sans", 10))
        text_to_decode_label.pack()

        text_to_decode_label = Label(help_window,
                                     text="\nSteganography is an Image and Audio Steganography tool "
...
# Footer label
footer_label = Label(window, text="Developed By Gourav Kushwaha")
